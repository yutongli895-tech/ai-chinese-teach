  ...
  return (
    <>
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed bottom-24 right-6 z-50 w-[350px] overflow-hidden rounded-2xl border border-stone-200 bg-white/90 backdrop-blur-xl shadow-2xl md:right-8"
          >
            {/* Header */}
            <div className="flex items-center justify-between border-b border-stone-100 bg-stone-50/50 px-4 py-3">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <h3 className="text-sm font-medium text-stone-900">AI 备课助教</h3>
            ...
            {/* Chat Area */}
            <div className="h-[350px] overflow-y-auto p-4 space-y-4 bg-stone-50/30">
            ...
            <div className="border-t border-stone-100 bg-white p-3">
              ...
              >
                <input
                  ...
                  placeholder="输入问题..."
                  className="w-full rounded-full border border-stone-200 bg-stone-50 py-2.5 pl-4 pr-10 text-sm focus:border-stone-400 focus:outline-none focus:ring-1 focus:ring-stone-400"
                />
                <button 
                  type="submit"
                  disabled={!input.trim() || isLoading}
                  className="absolute right-1.5 top-1.5 flex h-8 w-8 items-center justify-center rounded-full bg-stone-900 text-white transition-colors hover:bg-stone-700 disabled:opacity-50 disabled:cursor-not-allowed"
                >
      ...
      <motion.button
        ...
        className="fixed bottom-24 right-8 z-40 flex h-14 w-14 items-center justify-center rounded-full bg-white text-indigo-600 shadow-[0_8px_30px_rgb(0,0,0,0.12)] border border-indigo-100 transition-all hover:shadow-[0_8px_30px_rgb(79,70,229,0.2)]"
      >
